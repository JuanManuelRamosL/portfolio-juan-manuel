        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="flex-1">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
              Actualmente, estoy buscando oportunidades para aplicar mis habilidades en el desarrollo de software en un entorno que me permita seguir creciendo y aprendiendo. Siempre estoy abierto a nuevas colaboraciones. <br />
              <br />
              Mi objetivo es seguir creciendo como profesional y contribuir al mundo tecnológico con soluciones innovadoras y de calidad.
            </p>
          </div>
          {/* Imagen */}
          <div className="flex-1">
