...
const projects = [
  ...
  },
  {
    ...
    live2:
      "https://expo.dev/accounts/juanma_9/projects/tareas/builds/aef33dc8-ab99-4ea6-91d0-2d677e3175bc",
  },
  {
    title: "Space App",
    description:
...
export function Projects() {
  ...
  return (
    <section
      id="projects"
      className="py-20 bg-gray-50 dark:bg-slate-950 transition-colors duration-300"
    >
